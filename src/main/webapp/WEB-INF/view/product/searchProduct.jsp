...
<body>
	...
	<form>
		<input class="form-control" list="datalistOptions" name="keyword"
			onkeydown="return captureReturnKey(event)" onKeyUp="find()" id="keyword" placeholder="Type to search..."
			" style="width: 300px">
						...
						success : function(data) {
							...
							for ( var i in item) {
								...
								if (category1 === '식품') {
									...
									html += '<li class="list-group-item"> 최저가 : '+ lprice + '원</li>';
									html += '<li class="list-group-item"> 제조사 : '+ maker + '</li>';
									html += '<li class="list-group-item"> 브랜드 : '+ brand + '</li>';
									html += '</ul>';
