  ...
  <div class="container-fluid">
    ...
    <div class="collapse navbar-collapse" id="navbarSupportedContent">
      <ul class="navbar-nav me-auto mb-2 mb-lg-0">
       ...
       <li class="nav-item">
          <a class="nav-link active" aria-current="page" href="">레시피 일반</a>
        </li>
          <li class="nav-item">
          <a class="nav-link active" aria-current="page" href="">셰프 게시판</a>
        </li>
         <li class="nav-item">
          <a class="nav-link active" aria-current="page" href="">식재료 구매</a>
        </li>
